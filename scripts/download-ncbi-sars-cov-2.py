...
"""
(2021-05-06) Derived (by Aaron Petkau) from:
https://github.com/vector-engineering/covidcg/blob/master/workflow_genbank_ingest/scripts/download.py

(2020-12-21) Derived from:
https://github.com/nextstrain/ncov-ingest: fetch-from-genbank script

License is in LICENSE_NEXTSTRAIN_DOWNLOAD, same folder
...
params = {
    ...
    # to be nice.
    "email": "aaron.petkau@gmail.com",
}

headers = {
    "User-Agent": "https://github.com/apetkau/gdi-evaluation (aaron.petkau@gmail.com)",
}
